...
const products = [
  ...
  {
    id: '3',
    name: 'BOYA Wireless Lavalier Microphone BY-V1',
    image: '/Mic.jpg',
    price: '',
    category: 'Audio',
  ...
  {
    id: '4',
    name: 'UGREEN USB C Hub 4 Ports Type C to A Adapter',
    image: '/Hub.jpg',
    price: '',
    category: 'Accessories',
  ...
  {
    id: '5',
    name: 'CELLBELL C190 Berlin Office Chair',
    image: '/Chair.jpg',
    price: '',
    category: 'Furniture',
  ...
  {
    id: '6',
    name: 'RiaTech Extra Large Gaming Mouse Pad (900x400mm)',
    image: '/Pad.jpg',
    price: '',
    category: 'Accessories',
  ...
  {
    id: '7',
    name: 'Aluminum Foldable Laptop Stand',
    image: '/Stand.jpg',
    price: '',
    category: 'Accessories',
  ...
  {
    id: '8',
    name: 'Ambrane Multipurpose Tabletop Mobile Stand',
  ...
  {
    id: '9',
    name: 'Remote Control High-Speed Racing Car with LED Light',
    image: '/Car.jpg',
    price: '',
    category: 'Toys',
  ...
  {
    id: '10',
    name: 'FUR JADEN DSLR SLR Camera Backpack',
    image: '/Bag.jpg',
    price: '',
    category: 'Bags',
  ...
  {
    id: '11',
    name: 'Gizga Essentials Hard Drive Case Shell',
    image: '/Hard Drive Case.jpg',
    price: '',
    category: 'Accessories',
  ...
  {
    id: '12',
    name: 'Samsung Original 25W USB Type-C Travel Adapter',
    image: '/Charger.jpg',
    price: '',
  ...
  {
    id: '13',
    name: 'Red Lemon Titan Ultrafit Plus 15.6-inch Laptop Backpack',
    image: '/Bag2.jpg',
    price: '',
    category: 'Bags',
  ...
  {
    id: '14',
    name: 'MOCA Hard Laptop Sleeve for MacBook / 13–14 inch Laptops',
  ...
  {
    id: '15',
    name: 'SF Quartz Analog White Dial Black Strap Watch - NT7930PP01',
    image: '/Watch.jpg',
    price: '',
    category: 'Wearables',
